...
def main():
    ...
    for mut in mutations:
        ...
        gppions = grompp.Grompp512(gppions_mdp, sol_gro, sol_top, gppions_tpr, gmx_path=gmx_path)
        ...
        gppmin = grompp.Grompp512(gppmin_mdp, gio_gro, gio_top, gppmin_tpr, gmx_path=gmx_path)
        ...
        mdmin = mdrun.Mdrun512(gppmin_tpr, mdmin_trr, mdmin_gro, mdmin_edr, gmx_path=gmx_path)
        ...
        gppnpt = grompp.Grompp512(gppnpt_mdp, mdnvt_gro, gio_top,
